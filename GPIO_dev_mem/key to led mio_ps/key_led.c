...
#define DATA_1_RO            0xFF0A0064 // mio26 DATA_0
...
int main() {
 ...
 system("devmem 0xFF0A0204 w 0x00000000");  // set as input (DIRM_0 ) //key
 system("devmem 0xFF0A0244 w 0x00004000");  // set as output (DIRM_1 ) //led mio 40
